...
from apps.chama.models import Chama, Membership, MemberStatus, MembershipRole
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Admin membership created'))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Secretary membership created'))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Treasurer membership created'))
