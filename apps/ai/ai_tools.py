...
class ToolRouter:
    ...
    @staticmethod
    def get_contributions_status(chama: Chama, user: User, cycle: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def get_unpaid_members(chama: Chama, user: User, cycle: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def get_fines_summary(chama: Chama, user: User, cycle: Optional[int] = None) -> Dict[str, Any]:
        """
