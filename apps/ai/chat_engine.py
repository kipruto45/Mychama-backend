...
class FunctionTool:
    ...
    def execute(self, user, chama: Chama | None, **kwargs) -> dict[str, Any]:
...
Need immediate help? Contact your chama secretary directly."""
    ...
    @classmethod
    def _format_balance_response(cls, results: dict, chama: Chama | None) -> str:
...
Would you like to make a contribution or withdrawal?"""
    ...
    @classmethod
    def _format_contribution_response(cls, results: dict, chama: Chama | None) -> str:
    ...
    @classmethod
    def _format_withdrawal_response(cls, results: dict, chama: Chama | None) -> str:
    ...
    @classmethod
    def _format_loan_response(cls, results: dict, chama: Chama | None) -> str:
    ...
    @classmethod
    def _format_repayment_response(cls, results: dict, chama: Chama | None) -> str:
    ...
    @classmethod
    def _format_meeting_response(cls, results: dict, chama: Chama | None) -> str:
    ...
    @classmethod
    def _format_members_response(cls, results: dict, chama: Chama | None) -> str:
