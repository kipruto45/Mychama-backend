...
from .ai_prompt import get_role_suggestions
...
from .services import AIClientPool, AIGatewayService, AIServiceError, AIWorkflowService
...
@permission_classes([IsAuthenticated])
@require_feature('ai_basic', or_features=['ai_advanced'])
def _legacy_ai_chat_stream(request):
    """
...
@api_view(["POST"])
@permission_classes([IsAuthenticated])
def _legacy_ai_chat_stop(request):
    """
...
@permission_classes([IsAuthenticated])
@require_feature('ai_basic', or_features=['ai_advanced'])
def _legacy_ai_suggestions(request):
    """
...
@api_view(["GET"])
@permission_classes([IsAuthenticated])
def _legacy_ai_context(request):
    """
    GET /api/ai/context
...
@permission_classes([IsAuthenticated])
@require_feature('ai_basic', or_features=['ai_advanced'])
def _legacy_ai_conversations(request):
    """
...
@api_view(["GET"])
@permission_classes([IsAuthenticated])
def _legacy_ai_messages(request, conversation_id):
    """
