...
from apps.notifications.models import Notification, NotificationDelivery, NotificationDeliveryStatus
...
class AfricaTalkingWebhookView(BaseWebhookMixin, View):
    ...
    def post(self, request):
        ...
        callback_token = getattr(settings, 'OTP_SMS_CALLBACK_TOKEN', '')
