...
class AdminManagementService:
    ...
    def create_loan(
        ...
        # Get membership
        Membership.objects.get(chama=chama, user=member)
    ...
    def get_meeting_detail(meeting_id: int) -> dict[str, Any]:
        ...
        from apps.meetings.models import AgendaItem, Attendance, Meeting, Resolution
    ...
    def get_all_resolutions(
        ...
        from apps.meetings.models import Resolution
    ...
    def get_issue_detail(issue_id: int) -> dict[str, Any]:
        ...
        from apps.issues.models import Issue, IssueActivityLog, IssueComment
    ...
    def approve_refund(refund_id: int, actor: User) -> dict[str, Any]:
        """Approve a refund."""
        from apps.payments.models import PaymentRefundStatus
    ...
    def get_ledger_summary(
        ...
        """Get ledger summary."""
        from apps.finance.models import LedgerDirection, LedgerEntry
