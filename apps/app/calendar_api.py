...
from apps.chama.models import Membership, MemberStatus, MembershipRole
from apps.finance.models import Loan, LoanStatus, ContributionGoal
...
def get_action_item_events(user, chama_ids: list, from_date, to_date):
    ...
    for item in action_items:
        events.append({
            ...
            "deep_link": f"/secretary/resolutions",
