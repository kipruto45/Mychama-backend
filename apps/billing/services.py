...
def get_latest_subscription(chama) -> Subscription | None:
...
def ensure_trial_subscription(chama) -> Subscription | None:
...
def get_active_subscription(chama) -> Subscription | None:
...
def get_active_chama_from_request(request) -> Any | None:
    """
...
def get_plan_for_chama(chama) -> Plan | None:
