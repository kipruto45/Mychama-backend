...
def notifications_health_check(request):
    ...
    from django.conf import settings
    from apps.notifications.email import MailgunEmailProvider, DjangoEmailProvider, SendGridEmailProvider
...
def metrics_prometheus(request):
    ...
    metrics.extend([
        f'# HELP digital_chama_cpu_usage_percent CPU usage percentage',
        f'# TYPE digital_chama_cpu_usage_percent gauge',
        f'digital_chama_cpu_usage_percent {cpu_percent}',
        f'',
        f'# HELP digital_chama_memory_usage_percent Memory usage percentage',
        f'# TYPE digital_chama_memory_usage_percent gauge',
        f'digital_chama_memory_usage_percent {memory_percent}',
        f'',
        f'# HELP digital_chama_disk_usage_percent Disk usage percentage',
        f'# TYPE digital_chama_disk_usage_percent gauge',
    ...
    try:
        ...
        metrics.extend([
            f'# HELP digital_chama_total_users Total number of registered users',
            f'# TYPE digital_chama_total_users gauge',
            f'digital_chama_total_users {total_users}',
            f'',
            f'# HELP digital_chama_total_chamas Total number of chamas',
            f'# TYPE digital_chama_total_chamas gauge',
            f'digital_chama_total_chamas {total_chamas}',
            f'',
            f'# HELP digital_chama_active_chamas Number of active chamas',
            f'# TYPE digital_chama_active_chamas gauge',
            f'digital_chama_active_chamas {active_chamas}',
            f'',
            f'# HELP digital_chama_recent_contributions Contributions in last 24 hours',
            f'# TYPE digital_chama_recent_contributions gauge',
            f'digital_chama_recent_contributions {recent_contributions}',
            f'',
            f'# HELP digital_chama_recent_loans Loans in last 24 hours',
            f'# TYPE digital_chama_recent_loans gauge',
